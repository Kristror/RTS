...
namespace UserControlSystem
{
    public sealed class CommandButtonsModel
    {
        ...
        [Inject] private CommandCreatorBase<ISetRallyPointCommand> _rallyPointSeter;
        ...
        public void OnCommandButtonClicked(ICommandExecutor commandExecutor, ICommandsQueue commandsQueue)
        {
            ...
            _rallyPointSeter.ProcessCommandExecutor(commandExecutor, command => ExecuteCommandWrapper(command, commandsQueue));
        ...
        private void processOnCancel()
        {
            ...
            _rallyPointSeter.ProcessCancel();
